...
## Live Demo
A fully functional frontend for this AI model is deployed on Vercel. You can interact with the live application or view its source code below:

* **Live Web Interface:** [NeuroScan Web Interface](https://neuroscan-cnn.vercel.app/)
* **Frontend Source Code:** [Mizab1/NeuroScan-Frontend](https://github.com/Mizab1/NeuroScan-Frontend)
